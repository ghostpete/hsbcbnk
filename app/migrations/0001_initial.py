# Generated by Django 5.1.4 on 2025-04-16 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('CHECKING', 'CHECKING'), ('SAVINGS', 'SAVINGS'), ('MONEY MARKET', 'MONEY MARKET'), ('PLATINUM', 'PLATINUM'), ('CURRENT', 'CURRENT')], max_length=40)),
                ('account_category', models.CharField(choices=[('Individual', 'Individual'), ('Business', 'Business')], default='Individual', max_length=100)),
                ('balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bank_name', models.CharField(blank=True, default='HSBC Bank', max_length=200, null=True)),
                ...
                ('utility_bill', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True)),
                ...
                ('joint_account_holder_front_id_image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True)),
                ('joint_account_holder_back_id_image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=12)),
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now, help_text='You can choose the time of the transaction here.', verbose_name='Date of transaction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_name', models.CharField(blank=True, max_length=200, null=True)),
                ('amount', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now, help_text='Insert the date and time of transfer transaction', verbose_name='Date of transaction')),
                ('account_holder_name', models.CharField(blank=True, max_length=200, null=True)),
